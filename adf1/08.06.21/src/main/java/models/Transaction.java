...
public class Transaction {
    ...
    public Transaction(String transactionCode, Date transactionDate, Double unitPrice, Double area) {
    ...
    public void input() {
        ...
        this.transactionDate = DateTimeUtility.convertStringToDateTime(getScanner().next());
